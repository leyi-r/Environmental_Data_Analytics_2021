...
# par(mfrow = c(2,2), mar=c(4,4,4,4)) #divide screen into 2 by 2 screen
...
# since log-transformation, take 0 and outlier out
...
irradiancebydepth2 <- 
    ...
    geom_smooth(method = 'lm', se = FALSE, color = "black") #se=fALSE takes out confidence interval from the line
print(irradiancebydepth2)
...
corrplot.mixed(PeterPaulCorr, upper = "ellipse") #only show upper-half
```
