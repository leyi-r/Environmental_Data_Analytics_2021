...
Rainfall_Data_ts <- ts(BRA_complete$Rainfall,
...
Rainfall_Components <- as.data.frame(Rainfall_data_decomp$time.series[,1:3])
Temp_Components <- as.data.frame(Temp_data_decomp$time.series[,1:3])
